...
def get_cookies_file(uploaded_file=None):
    """
    Return cookies file from uploaded file or automatically fetch from Chrome.
    """
    if uploaded_file:
        ...
        return temp_path
    try:
        # Fetch Chrome cookies for youtube.com automatically
        cj = browser_cookie3.chrome(domain_name='youtube.com')
        if not cj:  # No cookies found
            return None
        ...
        print("Could not fetch cookies automatically:", e)
        return None
